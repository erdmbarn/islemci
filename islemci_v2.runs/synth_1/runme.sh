...
HD_PWD='C:/Users/erdmb/islemci_v2/islemci_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log islemci.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source islemci.tcl
